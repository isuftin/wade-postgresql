-- Function: "WADE_R"."XML_D_ALLOCATION_USE"(text, text, text, numeric)

-- DROP FUNCTION "WADE_R"."XML_D_ALLOCATION_USE"(text, text, text, numeric);

CREATE OR REPLACE FUNCTION "WADE_R"."XML_D_ALLOCATION_USE"(
    IN orgid text,
    IN reportid text,
...
END
  ...
  COST 1000;
ALTER FUNCTION "WADE_R"."XML_D_ALLOCATION_USE"(text, text, text, numeric)
  OWNER TO "WADE";
